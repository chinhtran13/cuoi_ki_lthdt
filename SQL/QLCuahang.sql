...
ALTER TABLE SanPham
ADD LoaiSP VARCHAR(255) NOT NULL;
--update 15/12
ALTER TABLE HoaDon
ALTER COLUMN SDT VARCHAR(15) NULL;

ALTER TABLE HoaDon
DROP CONSTRAINT FK__HoaDon__SDT__3F466844;

ALTER TABLE HoaDon
ADD CONSTRAINT FK__HoaDon__SDT__3F466844 FOREIGN KEY (SDT) REFERENCES ThanhVien(SDTTV) ON DELETE SET NULL;

ALTER TABLE HoaDon
ALTER COLUMN MaKM INT NULL;
